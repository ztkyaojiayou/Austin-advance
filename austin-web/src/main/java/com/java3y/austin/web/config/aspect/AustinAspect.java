package com.java3y.austin.web.config.aspect;
...
public class AustinAspect {
    ...
    /**
     * 只切AustinAspect注解
     * @within 匹配的是类上的注解，匹配后 类中实现的方法都会被Advice增强
     */
    @Pointcut("@within(com.java3y.austin.web.config.annotation.AustinAspect) || @annotation(com.java3y.austin.web.config.annotation.AustinAspect)")
