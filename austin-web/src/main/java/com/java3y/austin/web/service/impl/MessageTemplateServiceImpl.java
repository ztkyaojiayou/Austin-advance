...
public class MessageTemplateServiceImpl implements MessageTemplateService {
  ...
  public Page<MessageTemplate> queryList(MessageTemplateParam param) {
    ...
    String creator =
        StrUtil.isBlank(param.getCreator()) ? AustinConstant.DEFAULT_CREATOR : param.getCreator();
  ...
  public BasicResultVO startCronTask(Long id) {
    ...
    BasicResultVO basicResultVO = cronTaskService.addOrUpdateCronTask(xxlJobInfo);
  ...
  private void resetStatus(MessageTemplate messageTemplate) {
    ...
    if (Objects.nonNull(messageTemplate.getCronTaskId())
      ...
      XxlJobInfo xxlJobInfo = xxlJobUtils.buildXxlJobInfo(messageTemplate);
      cronTaskService.addOrUpdateCronTask(xxlJobInfo);
