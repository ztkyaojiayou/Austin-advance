package com.java3y.austin.handler.messagereceipt.stater.impl;

import com.java3y.austin.common.constant.CommonConstant;
import com.java3y.austin.common.enums.ChannelType;
import com.java3y.austin.handler.messageconsume.sendhandler.dingding.DingDingWorkNoticeMsgSendChannelHandler;
import com.java3y.austin.handler.messagereceipt.ReceiptMessageStater;
...
public class DingDingWorkReceiptStaterImpl implements ReceiptMessageStater {
    ...
    @Autowired
    private DingDingWorkNoticeMsgSendChannelHandler workNoticeHandler;
